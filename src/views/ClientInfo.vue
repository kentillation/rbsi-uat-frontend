                    ...
                    <v-toolbar-title>
                        <v-row>
                            <v-col cols="12" lg="6" md="6" sm="12">
                                <v-text-field v-model="search_item" label="Search CID/Last Name" class="pt-5"></v-text-field>
                            </v-col>
                        </v-row>
                    </v-toolbar-title>
                    <v-divider class="mx-4" inset vertical></v-divider>
                    <v-btn prepend-icon="mdi-plus" class="bg-teal-darken-3 me-4" @click="toNewClient" text><span
                            class="to-hide">&nbsp;New</span></v-btn>
                    ...
                    <v-container>
                        <v-row>
                            <v-col cols="12">
                                ...
                                <p><span class="text-grey-lighten-1">Type: </span>{{ getTitle(selectedClient?.type,
                                    typeItems,
                                    'type') }} </p>
                                ...
                                <p>
                                    ...
                                    <img :src="`http://127.1.1.0:8000/api/client_image/${selectedClient?.image_file}`" alt="Client Image" />
                                </p>
                            </v-col>
                        </v-row>
                    </v-container>
